...
class NotesManager(tk.Frame, tk.Tk):
    def __init__(self, container, controller, **kwargs):
        ...
        style.map('TButton', foreground=[('active', '!disabled', background_color)],
        ...
        def ui(l):
            ...
            a = ttk.Label(banner_frame, text="\U00002022  " +l + f"\t  {dates_times}", background=background_color, foreground=frame_colors, anchor="w")
        ...
        def new_file_func():
            ...
            file_name_label = ttk.Label(new_win_controls, text="Filename:", background=frame_colors, foreground=background_color)
            file_title_label = ttk.Label(new_win_controls, text="Title:", background=frame_colors, foreground=background_color)
            self.file_name = ttk.Entry(new_win_controls, textvariable=f_name, width=10, background=frame_colors, foreground=background_color)
            file_title = ttk.Entry(new_win_controls, textvariable=f_title, width=10, background=frame_colors, foreground=background_color)
            ...
            use_speech_to_text.place(x=70, y= 250)
        ...
        slogan = ttk.Label(banner_frame, text="YOUR SAVED NOTES WILL SHOW HERE", background=background_color, foreground=frame_colors, font=('Helvetica', 25, 'normal', 'italic'))
